...
[Read about it again](functions.md) if you need to.
...
[Dividing a long program into simple functions](functions-play.md) also
...
The built-in input function [returns a value](functions.md#return-values).
...
***
[Previous](dicts.md) | [Next](functions-play.md) |
