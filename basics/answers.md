...
3. Again, the code gives us a weird error message.
    ...
    - `namelist` is None. It should be `namelist.extend('theelous3')`,
        not `namelist = namelist.extend('theelous3')`. See [this thing](functions.md#return-values).
...
3. The code has some empty lines in it, and they divide it nicely into
    ...
    now the rest of the program [can't use the input function](functions.md#variable-names-and-built-in-things). It
...
3. The greet function prints a greeting.
    ```bash
    >> greet("World")
    Hello World
    >>
...
[List of contents](../README.md#list-of-content)